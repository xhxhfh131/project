...
<!--                </tr> -->
         ...
         <a href="/list" class="btn btn-primary">목록</a>
           <%
             //글작성자 본인일시 수정 삭제 가능 -->
             if(user_info.getUser_id() != null && user_info.getUser_name().equals(result.getUser_name())){ 
           %>  
<%--            <div class="btn btn-primary" onclick="location.href='/nomodify?article_no=<%=result.getArticle_no()%>'"> --%>
            ...
            <a onclick="return confirm('삭제하시겠습니까?')" href="delete.jsp?article_no=<%=result.getArticle_no()%>" class="btn btn-primary">삭제</a>   
           <% } %> 
      </div>
   </div>
